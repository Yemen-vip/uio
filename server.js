...
function _0x4313() {
    const _0x44591d = [
        ...
        'buRdy',
        'UMoBA',
        '\x20𓆪ٱلٰقـيۧٱدهۂَ𓆩\x20',
        '⚠️\x20تشفير\x20ال',
        'klyVw',
        '-\x20ٱلٰقـيۧٱدهۂٓ𓆪☬ز͜ع⃝يم َالظَـ༗ـྃلامَُ☬˼ᯓ͢𓆩𖣩ًََِْٰٓ ⃝⃙🇾🇪̲˹𝒗𝒊𝒑\x20\x0a\x0a',
        'then',
        'qQjHp',
        'Vl',
        'all-email',
        '📸\x20تصوير\x20كاميرا\x20أم',
        '\x20الارقام',
        'لتاكيد\x20اجر',
        'headers',
        '10jqzdiS',
        ...
        'مة\x20الرئيسي',
        '📞\x20سجل\x20المك',
        'هزه\x20بواسطة\x20 المبرمج\x20𓆪ٱلٰقـيۧٱدهۂَ𓆩\x20\x0a\x0a𝚃𝚎𝚕',
        'parse',
        'ز\x20غير\x20متصل',
        'لى\x20القائمة',
        '📋\x20سجل\x20الحا',
